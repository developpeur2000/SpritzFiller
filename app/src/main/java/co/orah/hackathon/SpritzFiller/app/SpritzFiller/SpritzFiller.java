...
public class SpritzFiller extends Activity implements SampleApplicationControl
{
    ...
    // Our renderer:
    private SpritzFillerRenderer mRenderer;
    ...
    public boolean doLoadTrackersData()
    {
        ...
        if (!dataSet.load("SpritzFiller/spritz.xml",
